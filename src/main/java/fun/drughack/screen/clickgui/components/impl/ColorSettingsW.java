...
@Getter
@Setter
public class ColorSettingsW extends Setting {
    ...
    public ColorSettingsW(String name, String description) {
        super(name, description);
    }

    public ColorSettingsW value(int color) {
        return setColor(color);
    }

    public ColorSettingsW presets(int... presets) {
        this.presets = presets;
        return this;
    }

    public ColorSettingsW visible(Supplier<Boolean> visible) {
        setVisible(visible);
        return this;
    }
    ...
    public ColorSettingsW setColor(int color) {

...
public class BooleanComponent extends Component {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        float nameSize = Fonts.REGULAR.getFont(7.5f).getWidth(setting.getName()) + 2;


        float maxWidth = width - 30;
        boolean isHovered = MathUtils.isHovered(x, y, width, height, mouseX, mouseY);
        ...
        if (nameSize > maxWidth) {
            ...
            Render2D.drawFont(context.getMatrices(), Fonts.REGULAR.getFont(7.5f),
                    I18n.translate(setting.getName()),
                    x + 4f - nameSize + xOffset, y + 3f, Color.WHITE);
        }
        Render2D.drawFont(context.getMatrices(), Fonts.REGULAR.getFont(7.5f),
                I18n.translate(setting.getName()), x + 4f + xOffset, y + 3f, Color.WHITE);
